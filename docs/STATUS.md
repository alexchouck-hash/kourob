...
| become better | **met in mechanism** | outcomes, settlement from reality (model-tier answers too, by citation: ADR-0010), quality multiplier, the shadow teacher disputing cheap tiers and blocking their promotion (ADR-0011) | only `note.v1` settles; no comparator for probabilistic answers; the teacher compares citations, not content |
